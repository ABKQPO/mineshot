...
public class FramebufferCapturer {
    ...
    public static final int TYPE = GL_UNSIGNED_BYTE;
    public static final Minecraft MC = Minecraft.getMinecraft();

    public final ByteBuffer bb;
    public final Dimension dim;
    public final byte[] line1;
    public final byte[] line2;
    public boolean flipColors = false;
    public boolean flipLines = false;
